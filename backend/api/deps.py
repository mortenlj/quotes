...
QUOTES = (
    ...
    Quote(id=105, quote="If everything seems to be going well, you have obviously overlooked something.",
    ...
    Quote(id=108, quote="Just when you see the light at the end of the tunnel, the roof caves in.",
          dedication="Forsyth's Second Corollary To Murphy's Laws"),
    Quote(id=109, quote="Nothing is impossible for the man who doesn't have to do it himself.",
    ...
    Quote(id=123, quote="No books are lost by lending except those you particularly wanted to keep.",
    ...
    Quote(id=126, quote="The difference between fiction and reality is that fiction has to make sense.",
          dedication="Tom Clancy"),
    Quote(id=127, quote="Early to rise, early to bed, makes a man healthy, wealthy and dead.",
    ...
    Quote(id=129, quote="There's a fine line between genius and insanity.  I have erased this line.",
    ...
    Quote(id=133, quote="Computers in the future may weigh no more than 1.5 tons.",
          dedication="Popular Mechanics, forecasting the relentless march of science, 1949"),
    Quote(id=134, quote="I think there is a world market for maybe five computers.",
          dedication="Thomas Watson, chairman of IBM, 1943"),
    Quote(id=135, quote="But what ... is it good for?",
          dedication="Engineer at the Advanced Computing Systems Division of IBM, 1968, commenting on the microchip."),
    Quote(id=136, quote="There is no reason anyone would want a computer in their home.",
    ...
    Quote(id=139, quote="We don't like their sound, and guitar music is on the way out.",
          dedication="Decca Recording Co. rejecting the Beatles, 1962."),
    Quote(id=140, quote="Heavier-than-air flying machines are impossible.",
          dedication="Lord Kelvin, president, Royal Society, 1895."),
    Quote(id=141, quote="Drill for oil? You mean drill into the ground to try and find oil? You're crazy.",
          dedication="Drillers who Edwin L. Drake tried to enlist to his project to drill for oil in 1859."),
    Quote(id=142, quote="Stocks have reached what looks like a permanently high plateau.",
          dedication="Irving Fisher, Professor of Economics, Yale University, 1929."),
    Quote(id=143, quote="Airplanes are interesting toys but of no military value.",
          dedication="Marechal Ferdinand Foch, Professor of Strategy, Ecole Superieure de Guerre."),
    Quote(id=144, quote="Everything that can be invented has been invented.",
          dedication="Charles H. Duell, Commissioner, U.S. Office of Patents, 1899."),
    Quote(id=145, quote="Louis Pasteur's theory of germs is ridiculous fiction.",
    ...
    Quote(id=247, quote="Even if you're on the right track, you'll get run over if you just sit there.",
    ...
    Quote(id=258, quote="The only thing that stops God sending a second Flood is that the first one was useless.",
